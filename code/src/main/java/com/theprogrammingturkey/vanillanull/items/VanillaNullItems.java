...
public class VanillaNullItems
{
	...
	public static final ItemStack t7VanillaNull = vanillaNullWrapper(Material.PURPLE_SHULKER_BOX);
	public static final ItemStack t8VanillaNull = vanillaNullWrapper(Material.BLACK_SHULKER_BOX);
	...
	public static void initItems()
	{
		...
		initItemMeta(t7VanillaNull);
		initItemMeta(t8VanillaNull);
	}
	...
	public static void initCratingRecipes()
	{
		...
		createRecipe(7, t7VanillaNull, Material.NETHERITE_BLOCK);
		createRecipe(8, t8VanillaNull, Material.NETHER_STAR);
	}
